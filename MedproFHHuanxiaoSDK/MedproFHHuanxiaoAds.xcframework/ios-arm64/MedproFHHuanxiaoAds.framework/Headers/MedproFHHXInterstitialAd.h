...
@interface MedproFHHXInterstitialAd : NSObject <MedproFHHXBidNotifiable>
 ...
 */
@property (nonatomic, weak, nullable) id<MedproFHHXInterstitialAdDelegate> delegate;
