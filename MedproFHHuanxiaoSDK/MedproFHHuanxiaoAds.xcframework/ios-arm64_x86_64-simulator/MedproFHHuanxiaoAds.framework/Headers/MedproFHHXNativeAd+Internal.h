 ...
 */
@interface MedproFHHXNativeAd (Internal)
 ...
 *
 * @discussion
 * 自渲染模式下，MedproFHHXNativeAd 自带的 MedproFHHXNativeAdVisibilityManager 会按"屏中心"自动调度
 ...
 *
 * 本方法做"软解绑"：
 *  1. 从 MedproFHHXNativeAdVisibilityManager 注销，立刻退出屏中心选举（防幽灵广告误响应）
 ...
 *
 * 仅自渲染模式生效；模板渲染模式由 MedproFHHXNativeAdView 自身的 willMoveToWindow
